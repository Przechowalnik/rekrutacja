export enum E_Routes {
  ...
  adminExchangesEdit = "adminExchangesEdit",
  adminExchangesNew = "adminExchangesNew",
  adminMarketingEmail = "adminMarketingEmail",
  adminPlanNew = "adminPlanNew",
  adminPlans = "adminPlans",
  adminPlansEdit = "adminPlansEdit",
  adminProducts = "adminProducts",
  adminProductsEdit = "adminProductsEdit",
  adminProductsNew = "adminProductsNew",
  ...
  apiCompanySubscriptionDelete = "apiCompanySubscriptionDelete",
...
export const routes = {
  ...
  [E_Routes.accountInvoices]: "/konto/faktury",
  ...
  [E_Routes.accountPoints]: "/konto/punkty",
  [E_Routes.accountProfile]: "/konto/profil",
  [E_Routes.accountReferral]: "/konto/polecenie",
  [E_Routes.accountSessions]: "/konto/sesje",
  [E_Routes.admin]: "/admin",
  [E_Routes.adminBlogPostEdit]: "/admin/blog",
  [E_Routes.adminBlogPostNew]: "/admin/blog/nowy",
  [E_Routes.adminBlogPosts]: "/admin/blog",
  [E_Routes.adminBugDetails]: "/admin/bledy",
  [E_Routes.adminBugEdit]: "/admin/bledy/edytuj",
  [E_Routes.adminBugs]: "/admin/bledy",
  [E_Routes.adminCouponEdit]: "/admin/kupony",
  [E_Routes.adminCouponNew]: "/admin/kupony/nowy",
  [E_Routes.adminCoupons]: "/admin/kupony",
  [E_Routes.adminExchanges]: "/admin/wymiany",
  [E_Routes.adminExchangesEdit]: "/admin/wymiany",
  [E_Routes.adminExchangesNew]: "/admin/wymiany/nowa",
  [E_Routes.adminMarketingEmail]: "/admin/marketing-email",
  [E_Routes.adminPlanNew]: "/admin/plany/nowy",
  [E_Routes.adminPlans]: "/admin/plany",
  [E_Routes.adminPlansEdit]: "/admin/plany",
  [E_Routes.adminProducts]: "/admin/produkty",
  [E_Routes.adminProductsEdit]: "/admin/produkty",
  [E_Routes.adminProductsNew]: "/admin/produkty/nowy",
  [E_Routes.adminReports]: "/admin/raporty",
  [E_Routes.adminSettingEdit]: "/admin/ustawienia/edytuj",
  [E_Routes.adminSettingNew]: "/admin/ustawienia/nowe",
  [E_Routes.adminSettings]: "/admin/ustawienia",
  ...
  [E_Routes.apiCompanySubscriptionDelete]: "/api/company/subscriptions/delete",
  ...
  [E_Routes.blogPostDetails]: "/blog",
  [E_Routes.blogPosts]: "/blog",
  [E_Routes.cities]: "/miasta",
  [E_Routes.company]: "/firma",
  [E_Routes.companyBugDetails]: "/firma/bledy",
  [E_Routes.companyBugs]: "/firma/bledy",
  [E_Routes.companyCard]: "/firma/karta",
  [E_Routes.companyDelete]: "/firma/usun",
  [E_Routes.companyInvoiceEdit]: "/firma/faktury/edytuj",
  [E_Routes.companyInvoices]: "/firma/faktury",
  ...
  [E_Routes.companyPoints]: "/firma/punkty",
  [E_Routes.companyPointsExchanges]: "/firma/punkty/wymiany",
  [E_Routes.companyProfile]: "/firma/profil",
  [E_Routes.companyProfileEdit]: "/firma/profil/edytuj",
  [E_Routes.companyReferral]: "/firma/polecenie",
  [E_Routes.companySettings]: "/firma/ustawienia",
  [E_Routes.companySubscriptionNew]: "/firma/subskrypcje/nowa",
  [E_Routes.companySubscriptions]: "/firma/subskrypcje",
