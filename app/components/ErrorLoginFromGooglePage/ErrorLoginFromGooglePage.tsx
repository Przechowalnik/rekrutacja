...
type T_ErrorLoginOnlyFromGooglePage = {
  errorText?: ErrorResponse;
};

export const ErrorLoginFromGooglePage = ({
  errorText,
}: T_ErrorLoginOnlyFromGooglePage) => {
  ...
  return (
    <Center inset={0} pos="fixed">
      <CardInfo
        ...
        description={t("loginFromGoogle.message")}
        title={t("loginFromGoogle.title")}
        w="750px"
      />
    </Center>
  );
