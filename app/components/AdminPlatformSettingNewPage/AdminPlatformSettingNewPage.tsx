...
export const AdminPlatformSettingNewPage = ({ plans }: { plans: T_Plans }) => {
  const [authenticatorOpen, setAuthenticatorOpen] = useState(false);

  const { t } = useTranslation(namespaces.adminSettingNew);
  ...
  const form = useForm({
    ...
    initialValues: {
      ...
      [formNames.freeTrialMaxListings]: "",
      [formNames.planId]: "",
      [formNames.pointsBigBug]: "",
      [formNames.pointsMediumBug]: "",
      [formNames.pointsReferralCompany]: "",
      [formNames.pointsReferralUser]: "",
      [formNames.pointsSmallBug]: "",
    },
    mode: "uncontrolled",
    validate: {
      ...
      submit(
        ...
        }),
        {
          action: getLocalizedRoute({
            route: E_Routes.adminSettingNew,
          }),
          method: "post",
        },
      );
