/*
  ...
  - The values [PARKING] on the enum `ListingPlotType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ListingPlotType_new" AS ENUM ('STORAGE', 'SERVICE', 'AGRICULTURAL', 'BUILDING', 'INVESTMENT', 'RECREATIONAL');
